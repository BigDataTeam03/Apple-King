...
/**
 * Servlet implementation class aProductQuestionInsertSurvlet
 */
@WebServlet("/aProductQuestionInsertSurvlet")
public class aProductQuestionInsertSurvlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public aProductQuestionInsertSurvlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		*/
        ...
        String cust_id = (String)session.getAttribute("userId");
        	...
        	System.out.println(" 문의 인서트에서 세션으로 받은 상품코드와 문의 내용" + question + "상품코드" + product_code);
        ...
        try {
			...
			System.out.println(" 문의 인서트 디비에 들어가는 쿼리" +ps.toString());
