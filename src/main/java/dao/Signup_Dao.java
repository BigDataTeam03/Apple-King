...
public class Signup_Dao {
	...
	public Signup_Dao() {
		...
		try{
			...
			dataSource = (DataSource)context.lookup("java:comp/env/jdbc/appleStore"); 
		}catch(Exception e) {
			e.printStackTrace();
		}
	}	
...
//		}//insertID()
		...
		public void insertUser(String cust_id, String pw, String name, String tel, String email, String domain, String address) {
